...
class GameManager:
    def __init__(self):
        ...
        appear = pygame.image.load("images/zom_appear/appear_1.png")
        self.mole.append(appear)
        appear = pygame.image.load("images/zom_appear/appear_2.png")
        self.mole.append(appear)
        appear = pygame.image.load("images/zom_appear/appear_3.png")
        self.mole.append(appear)
        appear = pygame.image.load("images/zom_appear/appear_4.png")
        self.mole.append(appear)
        appear = pygame.image.load("images/zom_appear/appear_5.png")
        self.mole.append(appear)
        appear = pygame.image.load("images/zom_appear/appear_6.png")
        self.mole.append(appear)
        appear = pygame.image.load("images/zom_die/die_4.png")
        self.mole.append(appear)
        appear = pygame.image.load("images/zom_die/die_5.png")
        self.mole.append(appear)
        appear = pygame.image.load("images/zom_die/die_6.png")
        self.mole.append(appear)
        appear = pygame.image.load("images/zom_die/die_7.png")
        self.mole.append(appear)
        appear = pygame.image.load("images/zom_die/die_8.png")
        self.mole.append(appear)
    ...
    def restart_game(self):
        ...
        game_over = "GAME OVER \t\t\t YOUR SCORE: " + str(self.score)
        game_over_text = self.font_obj.render(game_over, True, (255, 255, 255))
        game_over_text_pos = game_over_text.get_rect()
        game_over_text_pos.centerx = 400
        game_over_text_pos.centery = self.FONT_TOP_MARGIN
...
class SoundEffect:
    def __init__(self):
        self.mainTrack = pygame.mixer.music.load("sounds/themesong.mp3")
...
###############################################################
# Initialize the game
ICON = pygame.image.load("images/zom_icon.png")
